            ...
            <div>
                ...
                <div className="container container w3-container w3-center w3-animate-opacity" style={{ margin: "auto", width: "75%" }}>
                    <div className="jumbotron">
                        ...
                        <div className="row">
                            <ul className="col-md-4" style={{ color: "white", fontSize: "24px" }}>
                            <li>
                                teachers
                            </li>
                            </ul>
                            <div className="col-md-4" style={{ color: "white", fontSize: "24px" }}>Students</div>
                            <div className="col-md-4" style={{ color: "white", fontSize: "24px" }}>Guardians</div>
                        </div>
